 ...
 *
 *
 *  Route Class 是让以编程的方式来直接提供 Route 路由信息的。
 *  以配置的方式 则是 以GatewayProperties 类来实现
 *
 *  Route 对象是 AsyncRouter builder 后最终实例化的对象。
 *
 *  构建出来的Route 元信息 包含了 predicate通过匹配后的 filter 等等 信息
 * @author Spencer Gibb
 */
public class Route implements Ordered {
	...
	/**
	 *  该类是用来承载  Predicate 载体类 用于 多个操作符的关联
	 */
